...
class TaskViewsTestCase(TestCase):
    ...
    def test_authorization_view(self):
        ...
        self.assertEqual(response.data['message'], f'Hi {self.user.username}! Congratulations on being authenticated!')
    ...
    def test_task_list(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(len(response.data), 2)  # Assuming there are 2 tasks in the database
    ...
    def test_task_update(self):
        ...
        data = {'title': 'Updated Task', 'description': 'Updated Description','Due_date':'2024-01-12','status':'OPEN'}
    ...
    def test_tag_list(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(len(response.data), 2)  # Assuming there are 2 tags in the database
